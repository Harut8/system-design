...
async def get_feed(
    ...
    """
    Get personalized feed for a user with Redis caching.
    Returns cached results when available.
    """
    posts, next_cursor, has_more, cached, cache_age = await feed_service.get_feed(
        user_id=user_id,
        limit=limit,
        cursor=cursor,
    )
...
async def create_post(
    ...
    """Create a new post with automatic fan-out to followers."""
...
async def delete_post(
    ...
    """Delete a post and invalidate caches."""
